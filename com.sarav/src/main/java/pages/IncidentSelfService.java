...
public class IncidentSelfService extends TestNgHooks {
	...
	public IncidentSelfService clickIncident() throws InterruptedException {
	...
	public IncidentDataServices clickOnResultingIncNum() {
	...
	public IncidentSelfService verifyAssessIncident(String existingIncNum) {
		System.out.println("Num: " + existingIncNum + "\nAssignedTo: " + resultantAssignedTo);
